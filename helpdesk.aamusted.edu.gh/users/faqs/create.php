...
<div class="tracking-normal pt-20">
    <div class="mx-6 bg-bgCream shadow-md shadow-gray-500">
        <div class="flex relative w-full mx-auto items-center justify-center">
            <div class="z-10 w-full bg-red-700">
                <p class=" uppercase text-center text-sm py-3 lg:text-lg font-semibold text-white">Help Desk Frequently Asked Questions</p>
            </div>
        </div>
        
        <!-- FAQ Images -->
        <div class="flex mx-auto justify-center items-center">
            <div class="grid grid-cols-2 md:grid-cols-3 xl:grid-cols-4 gap-6 my-6 w-full mx-6">
                        <a href="index/171bf9ff-b3d3-4c37-8ea7-87c9f8f3154a.php">
                <div class="relative bg-white h-52 lg:h-80 rounded transform hover:-translate-y-2 shadow-2xl transition duration-300 overflow-hidden">
                    ...
                    <div class="flex mx-auto justify-center items-center">
                        ...
                        <a href="index/267e46cb-07cc-4891-b945-13c4c566c487.php">
                <div class="relative bg-white h-52 lg:h-80 rounded transform hover:-translate-y-2 shadow-2xl transition duration-300 overflow-hidden">
                    <div class="absolute inset-0 w-full h-full bg-gray-800 bg-opacity-75"></div>
                    <h1 class="text-white text-center text-lg lg:text-2xl font-semibold absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2">
                        WiFi Connectivity
                    ...
                    <div class="flex mx-auto justify-center items-center">
                        ...
                        <a href="index/2ad2a795-da9e-42aa-a60b-a4f0a0ebe949.php">
                <div class="relative bg-white h-52 lg:h-80 rounded transform hover:-translate-y-2 shadow-2xl transition duration-300 overflow-hidden">
                    <div class="absolute inset-0 w-full h-full bg-gray-800 bg-opacity-75"></div>
                    <h1 class="text-white text-center text-lg lg:text-2xl font-semibold absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2">
                        Student Mail
                    ...
                    <div class="flex mx-auto justify-center items-center">
                        ...
                        <a href="index/5a99d49f-3098-440c-87d1-a698e188a5b0.php">
                <div class="relative bg-white h-52 lg:h-80 rounded transform hover:-translate-y-2 shadow-2xl transition duration-300 overflow-hidden">
                    <div class="absolute inset-0 w-full h-full bg-gray-800 bg-opacity-75"></div>
                    <h1 class="text-white text-center text-lg lg:text-2xl font-semibold absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2">
                    ...
                    <div class="flex mx-auto justify-center items-center">
                        ...
                        <a href="index/7cda0225-ace4-488b-82a6-ccdaf9252e4a.php">
                <div class="relative bg-white h-52 lg:h-80 rounded transform hover:-translate-y-2 shadow-2xl transition duration-300 overflow-hidden">
                    <div class="absolute inset-0 w-full h-full bg-gray-800 bg-opacity-75"></div>
                    <h1 class="text-white text-center text-lg lg:text-2xl font-semibold absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2">
                        Student Portal
                    ...
                    <div class="flex mx-auto justify-center items-center">
                        ...
                        <a href="index/8a70cf6f-3e7f-4d37-9231-d271a61b38c5.php">
                <div class="relative bg-white h-52 lg:h-80 rounded transform hover:-translate-y-2 shadow-2xl transition duration-300 overflow-hidden">
                    <div class="absolute inset-0 w-full h-full bg-gray-800 bg-opacity-75"></div>
                    <h1 class="text-white text-center text-lg lg:text-2xl font-semibold absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2">
                    ...
                    <div class="flex mx-auto justify-center items-center">
                        ...
                        <a href="index/c6ab3b39-e7e7-4665-b9a5-6bcd63ee78bb.php">
                <div class="relative bg-white h-52 lg:h-80 rounded transform hover:-translate-y-2 shadow-2xl transition duration-300 overflow-hidden">
                    <div class="absolute inset-0 w-full h-full bg-gray-800 bg-opacity-75"></div>
                    <h1 class="text-white text-center text-lg lg:text-2xl font-semibold absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2">
                        Course Registration
            ...
            <a href="index/c6ab3b39-e7e7-4665-b9a5-6bcd63ee78bbAdm.php">
                <div class="relative bg-white h-52 lg:h-80 rounded transform hover:-translate-y-2 shadow-2xl transition duration-300 overflow-hidden">
                    <div class="absolute inset-0 w-full h-full bg-gray-800 bg-opacity-75"></div>
                    <h1 class="text-white text-center text-lg lg:text-2xl font-semibold absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2">
                        Admissions
...
<link href="../../../cdn.datatables.net/buttons/1.2.2/css/buttons.dataTables.css" rel="stylesheet" />
    ...
    <title>AAMUSTED Help Desk - FAQs</title>
    <link rel="icon" href="../../images/logo.ico"/>
</head>
<body>
    <div class="font-inter bg-white"></div>
