...
<!-- Mirrored from helpdesk.uew.edu.gh/users/faqs/index/171bf9ff-b3d3-4c37-8ea7-87c9f8f3154a by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 24 Jul 2024 15:09:37 GMT -->
...
<div class="flex lg:space-x-4 w-full py-16 ">
    ...
    <div class="relative hidden lg:block bg-emerald-800 lg:w-60 mt-10 h-screen">
        ...
        <a href="c6ab3b39-e7e7-4665-b9a5-6bcd63ee78bbAdm.php">
            ...
            <a href="../../tickets/create.v" class="bg-yellow-400 flex">
        ...
        <div class="flex-1 my-4 lg:m-10 shadow-xl rounded-md">
            <div class="w-full text-center bg-red-700 text-base lg:text-xl py-4 text-white uppercase font-semibold p-4">
                    Virtual Classroom F.A.Q <span class="lowercase">s</span>.
            </div>
                ...
                <div class="btn-wrapper">
                    ...
                    <p class="text-left">How do I login to the V-Class?</p>
                </button>
                </div>
                <div class="collepsing-div lg:px-4 px-2 bg-gray-800 text-white shadow-md shadow-blue-500" style="display:none;">
                        ...
                        <div class="mx-auto" id="pdf-viewer">
                                ...
                                <script>
                                    var pdfUrl = "../../../storage/faq_answer_files/1717501108.pdf";
                ...
                <div class="btn-wrapper">
                    ...
                    <p class="text-left">What do I do when I get user account is not available on this site when I try to access V-Class?</p>
                </button>
                </div>
                <div class="collepsing-div lg:px-4 px-2 bg-gray-800 text-white shadow-md shadow-blue-500" style="display:none;">
                                            <ul class="ml-4 md:ml-6">
                                                        <li class="list-disc text-sm py-1">Create a ticket and include your student number (20******), describing the problem</li>
                                                        <li class="list-disc text-sm py-1">OR</li>
                                                        <li class="list-disc text-sm py-1">Visit the IT SUPPORT CENTRE at Computer Lab 3</li>
                                                    </ul>
                ...
                <div class="btn-wrapper">
                    ...
                    <p class="text-left">I’ve forgotten my user credentials, what do I do?</p>
                </button>
                </div>
                <div class="collepsing-div lg:px-4 px-2 bg-gray-800 text-white shadow-md shadow-blue-500" style="display:none;">
                                            <ul class="ml-4 md:ml-6">
                                                        <li class="list-disc text-sm py-1">Visit the AAMUSTED V-class portal</li>
                                                        <li class="list-disc text-sm py-1">Click on forgotten password and follow the procedure to retrieve your credentials.</li>
                                                    </ul>
