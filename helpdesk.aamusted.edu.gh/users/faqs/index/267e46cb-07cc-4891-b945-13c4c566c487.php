      ...
      <div style="background: linear-gradient(to bottom, #800000, #4B0000, #000000); opacity: 0.8; width: 100%;" class="flex flex-wrap items-center justify-between px-4 py-2">
          <div class="inline-flex">
            <a href="../../../index.php" class="flex items-center border-r-2 border-gray-200">
              <img src="../../../images/logo.png" class="h-10 px-2" alt="UEW Logo" />
            </a>
    ...
    <div class="relative hidden lg:block bg-emerald-800 lg:w-60 mt-10 h-screen">
        ...
        <div class="flex-1 my-4 lg:m-10 shadow-xl rounded-md">
            <div class="w-full text-center bg-red-700 text-base lg:text-xl py-4 text-white uppercase font-semibold p-4">
                    WiFi Connectivity F.A.Q <span class="lowercase">s</span>.
            </div>
                ...
                <div class="btn-wrapper">
                    ...
                    <p class="text-left">Windows Laptop</p>
                </button>
                </div>
                <div class="collepsing-div lg:px-4 px-2 bg-gray-800 text-white shadow-md shadow-blue-500" style="display:none;">
                                            <ul class="ml-4 md:ml-6">
                                                        <li class="list-disc text-sm py-1">Click on the Network Button at the bottom of the taskbar.</li>
                                                        <li class="list-disc text-sm py-1">Tap on the AAMUSTED Enterprise to configure your device for use.</li>
                                                        <li class="list-disc text-sm py-1">Your browser will redirect to a page to gain access.</li>
                                                        <li class="list-disc text-sm py-1">Login as a guest</li>
                                                        <li class="list-disc text-sm py-1">OR</li>
                                                        <li class="list-disc text-sm py-1">Login using username and password.</li>
                                                        <li class="list-disc text-sm py-1">Click on accept terms to continue</li>
                                                        <li class="list-disc text-sm py-1">Enter your student number and applicant ID as password.</li>
                                                        <li class="list-disc text-sm py-1">Submit to gain access to the WiFi Connectivity</li>
                                                    </ul>
                ...
                <div class="btn-wrapper">
                    ...
                    <p class="text-left">Mobile Phone</p>
                </button>
                </div>
                <div class="collepsing-div lg:px-4 px-2 bg-gray-800 text-white shadow-md shadow-blue-500" style="display:none;">
                                        <div class="flex flex-col justify-center py-2 w-full">
                        <div class="w-full flex items-center">
                            <div class="mx-auto" id="preloader">
                                <div class="spinner" role="status">
                                    <svg aria-hidden="true" class="inline lg:w-24 lg:h-24 w-16 h-16 text-gray-200 animate-spin dark:text-gray-600 fill-blue-800" viewBox="0 0 100 101" fill="none" xmlns="http://www.w3.org/2000/svg">
                        ...
                        <div class="mx-auto" id="pdf-viewer">
                                                                                            <script src="../../../../cdnjs.cloudflare.com/ajax/libs/pdf.js/2.11.338/pdf.js"></script>
                                <script>
                                    var pdfUrl = "../../../storage/faq_answer_files/1717501216.pdf";
                                    ...
                                    pdfjsLib.getDocument(pdfUrl).promise.then(function(pdf) {
                                        ...
                                        for (var pageNumber = 1; pageNumber <= totalPages; pageNumber++) {
                                            ...
                                            pdf.getPage(pageNumber).then(function(page) {
                                                var scale = 1.5; // Set desired scale (adjust as needed)
                                        ...
                                        // Hide preloader once PDF is loaded
                                        document.getElementById('preloader').style.display = 'none';
                                    });
                                </script>
                                                                                            <script src="../../../../cdnjs.cloudflare.com/ajax/libs/pdf.js/2.11.338/pdf.js"></script>
                                <script>
                                    var pdfUrl = "../../../storage/faq_answer_files/index.php";
  ...
  $(this)
    ...
    <!-- <a href="https://wa.link/6o91me" target="_blank">
        ...
        <div class="flex w-full justify-between items-center px-4">
            <a href="../../../index.html" class="flex flex-col items-center text-gray-700">
