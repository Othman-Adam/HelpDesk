    ...
    <div class="relative hidden lg:block bg-emerald-800 lg:w-60 mt-10 h-screen">
        ...
        <div class="flex-1 my-4 lg:m-10 shadow-xl rounded-md">
            <div class="w-full text-center bg-red-700 text-base lg:text-xl py-4 text-white uppercase font-semibold p-4">
                    Finance Related Issues F.A.Q <span class="lowercase">s</span>.
            </div>
            ...
            <div class="accordion-wrapper active shadow-xl mb-2 p-2">
                <div class="btn-wrapper">
                    ...
                    <p class="text-left">Which financial institutions have been accredited for fee payment?</p>
                </button>
                </div>
                <div class="collepsing-div lg:px-4 px-2 bg-gray-800 text-white shadow-md shadow-blue-500" style="display:none;">
                                            <ul class="ml-4 md:ml-6">
                                                        <li class="list-disc text-sm py-1">Ecobank</li>
                                                        <li class="list-disc text-sm py-1">Fidelity bank</li>
                                                        <li class="list-disc text-sm py-1">Universal Merchant Bank</li>
                                                        <li class="list-disc text-sm py-1">UBA</li>
                                                        <li class="list-disc text-sm py-1">Access Bank</li>
                                                        <li class="list-disc text-sm py-1">GCB</li>
                                                        <li class="list-disc text-sm py-1">Unibank</li>
                                                    </ul>
