    ...
    <div class="relative hidden lg:block bg-emerald-800 lg:w-60 mt-10 h-screen">
        ...
        <div class="flex-1 my-4 lg:m-10 shadow-xl rounded-md">
            <div class="w-full text-center bg-red-700 text-base lg:text-xl py-4 text-white uppercase font-semibold p-4">
                    Student Portal F.A.Q <span class="lowercase">s</span>.
            </div>
                ...
                <div class="btn-wrapper">
                    ...
                    <p class="text-left">I forgot my password to the AAMUSTED OSIS Portal. What do I do?</p>
                </button>
                </div>
                <div class="collepsing-div lg:px-4 px-2 bg-gray-800 text-white shadow-md shadow-blue-500" style="display:none;">
                                            <ul class="ml-4 md:ml-6">
                                                        <li class="list-disc text-sm py-1">Go to https://osissip.osis.online/auth/login/</li>
                                                        <li class="list-disc text-sm py-1">Click on forgot password</li>
                                                        <li class="list-disc text-sm py-1">Enter your student email (eg. 5201040461@st.aamusted.edu.gh ), a reset link will be sent to your that email</li>
                                                        <li class="list-disc text-sm py-1">Click on &quot;continue&quot; and check your email. ( reset link has been sent to &quot;your mail&quot;. Please check this email to complete the process)</li>
                                                        <li class="list-disc text-sm py-1">If you do not see the email in your inbox, kindly check your spam folder.</li>
                                                        <li class="list-disc text-sm py-1">Otherwise, visit student records office for assistance</li>
                                                    </ul>
                ...
                <div class="btn-wrapper">
                    ...
                    <p class="text-left">How do I login to AAMUSTED Student Portal?</p>
                </button>
                </div>
                <div class="collepsing-div lg:px-4 px-2 bg-gray-800 text-white shadow-md shadow-blue-500" style="display:none;">
                                            <ul class="ml-4 md:ml-6">
                                                        <li class="list-disc text-sm py-1">Students can access their students&#039; portal by logging on to https://osissip.osis.online/auth/login</li>
                                                        <li class="list-disc text-sm py-1">Your Username and password is the credential given to you by the university to have access to your students&#039; portal and other services offered by the university to students.</li>
                                                    </ul>
                ...
                <div class="btn-wrapper">
                    ...
                    <p class="text-left">Can I access results for past semesters?</p>
                </button>
                </div>
                <div class="collepsing-div lg:px-4 px-2 bg-gray-800 text-white shadow-md shadow-blue-500" style="display:none;">
                                            <ul class="ml-4 md:ml-6">
                                                        <li class="list-disc text-sm py-1">Go to the students portal, login and click  on the menu icon and select Academic Results</li>
                                                        <li class="list-disc text-sm py-1">All previous semesters results will be shown on the page</li>
                                                    </ul>
                ...
                <div class="btn-wrapper">
                    ...
                    <p class="text-left">When can I check my results?</p>
                </button>
                </div>
                <div class="collepsing-div lg:px-4 px-2 bg-gray-800 text-white shadow-md shadow-blue-500" style="display:none;">
                                            <ul class="ml-4 md:ml-6">
                                                        <li class="list-disc text-sm py-1">After it has been approved by the department</li>
                                                    </ul>
