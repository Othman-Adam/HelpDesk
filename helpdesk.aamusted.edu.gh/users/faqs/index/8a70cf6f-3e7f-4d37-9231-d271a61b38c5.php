            ...
            <ul class='flex font-playfair space-x-6 text-white text-sm font-semibold'>
             ...
             <!--  <button class="relative flex group self-end upload-modal-button" data-modal="uploadModal">
              ...
              <!-- Hide button when on Staff Page -->
                ...
                <a href="../create.php" class="relative flex group items-center justify-center">
                  <li class="group-hover:bg-yellow-100 hover:text-uewBlue flex space-x-2 text-uewBlue bg-white px-4 py-1 rounded-full">
        ...
        <div id="sideBar" class="fixed z-40 hidden transform transition-transform duration-700 ease-in-out px-2 min-h-screen bg-gray-900 w-full top-0 text-gray-400 right-0" id="navbar-default">
          ...
          <ul class="mt-32 space-y-2">
           ...
           <!--  <li class="border-b border-gray-800">
            ...
            <li class="border-b border-gray-800">
                <a href="../create.php" class="flex items-center justify-start p-2 rounded hover:bg-gray-300 hover:text-blue-900 group">
    ...
    <div id="uploadModal" class="upload-modal flex z-10 hidden fixed backdrop-blur-sm items-center shadow-lg justify-center h-screen w-screen top-0 left-0 bg-black bg-opacity-60">
        <div class="bg-white mx-auto w-full md:w-2/5">
            ...
            <form action="https://helpdesk.aamusted.edu.gh/staffPageLogin" method="POST" class="px-5">
                <input type="hidden" name="_token" value="1J6n76KKf48x1Ny3ua4dGrtIKjkb9nB9Ig0xjG85">
...
<div class="flex lg:space-x-4 w-full py-16 ">
    <!-- <div class="flex lg:hidden items-center justify-center text-center -ml-2 absolute mt-32 h-6 w-12 bg-gray-700 rounded-tl-full rounded-tr-full rotate-90">
        <svg xmlns="http://www.w3.org/2000/svg" fill="currentColor" class="bi bi-caret-right -rotate-90 text-white w-5 h-5" viewBox="0 0 16 16">
    ...
    <div class="relative hidden lg:block bg-emerald-800 lg:w-60 mt-10 h-screen">
        <div class="border border-emerald-900 text-emerald-900 bg-white pl-4 py-2">
        <p class="font-medium">All FAQs</p>
        </div>
                <a href="171bf9ff-b3d3-4c37-8ea7-87c9f8f3154a.php">
            <div class="border-b border-emerald-700 pl-4 py-2 hover:bg-emerald-900" style="">
            <p class="text-white font-medium">Virtual Classroom</p>
            </div>
        </a>
                <a href="267e46cb-07cc-4891-b945-13c4c566c487.php">
            <div class="border-b border-emerald-700 pl-4 py-2 hover:bg-emerald-900" style="">
            <p class="text-white font-medium">WiFi Connectivity</p>
            </div>
        </a>
                <a href="2ad2a795-da9e-42aa-a60b-a4f0a0ebe949.php">
            <div class="border-b border-emerald-700 pl-4 py-2 hover:bg-emerald-900" style="">
            <p class="text-white font-medium">Student Mail</p>
            </div>
        </a>
                <a href="5a99d49f-3098-440c-87d1-a698e188a5b0.php">
            <div class="border-b border-emerald-700 pl-4 py-2 hover:bg-emerald-900" style="">
            <p class="text-white font-medium">Finance Related Issues</p>
            </div>
        </a>
                <a href="7cda0225-ace4-488b-82a6-ccdaf9252e4a.php">
            <div class="border-b border-emerald-700 pl-4 py-2 hover:bg-emerald-900" style="">
            <p class="text-white font-medium">Student Portal</p>
            </div>
        </a>
                <a href="8a70cf6f-3e7f-4d37-9231-d271a61b38c5.php">
            <div class="border-b border-emerald-700 pl-4 py-2 hover:bg-emerald-900" style="background-color: #2D7D7F;">
            <p class="text-white font-medium">Accessing the Help Desk</p>
            </div>
        </a>
                <a href="c6ab3b39-e7e7-4665-b9a5-6bcd63ee78bb.php">
            <div class="border-b border-emerald-700 pl-4 py-2 hover:bg-emerald-900" style="">
            <p class="text-white font-medium">Course Registration</p>
            </div>
        </a>
        <a href="c6ab3b39-e7e7-4665-b9a5-6bcd63ee78bbAdm.php">
            <div class="border-b border-emerald-700 pl-4 py-2 hover:bg-emerald-900" style="">
            <p class="text-white font-medium">Admissions</p>
            </div>
        </a>
                <div class="absolute flex w-full flex-col bottom-0 right-0 left-0">
            <a href="../../tickets/create.php" class="bg-yellow-400 flex">
                <div class="flex border-b border-yellow-600 pl-4 py-2 hover:bg-yellow-500 text-blue-900 w-full" >
                    <p class="font-semibold">Issue Tickets</p>
                    <svg xmlns="http://www.w3.org/2000/svg" fill="currentColor" class="bi bi-send w-4 h-4 ml-2 inline-flex self-center" viewBox="0 0 16 16">
                    <path d="M15.854.146a.5.5 0 0 1 .11.54l-5.819 14.547a.75.75 0 0 1-1.329.124l-3.178-4.995L.643 7.184a.75.75 0 0 1 .124-1.33L15.314.037a.5.5 0 0 1 .54.11ZM6.636 10.07l2.761 4.338L14.13 2.576zm6.787-8.201L1.591 6.602l4.339 2.76z"/>
                    </svg>
                </div>
            </a>
                                    <a href="../../../login.php" class="bg-yellow-400 flex">
                <div class="flex border-b border-yellow-600 pl-4 py-2 text-blue-900 hover:bg-yellow-500 w-full" >
                    <p class="font-semibold">View Tickets</p>
                    <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-folder-fill w-4 h-4 ml-2 inline-flex self-center" viewBox="0 0 16 16">
        ...
        <div class="flex-1 my-4 lg:m-10 shadow-xl rounded-md">
            <div class="w-full text-center bg-red-700 text-base lg:text-xl py-4 text-white uppercase font-semibold p-4">
                    Accessing the Help Desk F.A.Q <span class="lowercase">s</span>.
            </div>
                        <div class="accordion-wrapper active shadow-xl mb-2 p-2">
                <div class="btn-wrapper">
                    <button class="flex-col">
                        <div class="w-32 bg-gradient-to-r from-blue-400 via-blue-200 to-white rounded-l-full">
                        <svg xmlns="http://www.w3.org/2000/svg" fill="currentColor" class="bi bi-question-octagon-fill w-4 h-4 lg:w-5 lg:h-5 lg:mr-2 mr-1 text-blue-700 " viewBox="0 0 16 16">
                    ...
                    <p class="text-left">How do I access the Frequently Asked Questions?</p>
                </button>
                </div>
                <div class="collepsing-div lg:px-4 px-2 bg-gray-800 text-white shadow-md shadow-blue-500" style="display:none;">
                                            <ul class="ml-4 md:ml-6">
                                                        <li class="list-disc text-sm py-1">At the home page frequently asked questions for various student and staff related issues are being displayed</li>
                                                        <li class="list-disc text-sm py-1">Click on the one you are seeking help from</li>
                                                        <li class="list-disc text-sm py-1">Several questions that are being asked frequently will be displayed</li>
                                                        <li class="list-disc text-sm py-1">If any of those FAQs does not solve your problem, issue a ticket to get support from experts within a short time</li>
                                                    </ul>
                ...
                <div class="btn-wrapper">
                    ...
                    <p class="text-left">How do I login the help desk on my mobile device?</p>
                </button>
                </div>
                <div class="collepsing-div lg:px-4 px-2 bg-gray-800 text-white shadow-md shadow-blue-500" style="display:none;">
                                            <ul class="ml-4 md:ml-6">
                                                        <li class="list-disc text-sm py-1">On the menu icons at the bottom of the page click on Login</li>
                                                        <li class="list-disc text-sm py-1">For first years use your index number as username and temporary index number / applicant ID as password</li>
                                                        <li class="list-disc text-sm py-1">For continuing students use your index number as both username and password, you will forced to change password after logging in</li>
                                                        <li class="list-disc text-sm py-1">You will be redirected to a page where all previous tickets you have issued will be displayed</li>
                                                    </ul>
                ...
                <div class="btn-wrapper">
                    ...
                    <p class="text-left">How do I issue a ticket, when I need support?</p>
                </button>
                </div>
                <div class="collepsing-div lg:px-4 px-2 bg-gray-800 text-white shadow-md shadow-blue-500" style="display:none;">
                                            <ul class="ml-4 md:ml-6">
                                                        <li class="list-disc text-sm py-1">On the menu icons at the bottom of the page click on Issue Ticket</li>
                                                        <li class="list-disc text-sm py-1">Fill the ticket form with your student number, select a help topic from the list of help topics</li>
                                                        <li class="list-disc text-sm py-1">Select others if none suits your problem</li>
                                                        <li class="list-disc text-sm py-1">Describe your problem clearly, in the description box</li>
                                                        <li class="list-disc text-sm py-1">Attach a file to your ticket, if necessary to help dissolve your problem</li>
                                                        <li class="list-disc text-sm py-1">Click on send to submit the ticket</li>
                                                        <li class="list-disc text-sm py-1">A response will sent after a couple of hours, login to check on the status of your ticket</li>
                                                    </ul>
                ...
                <div class="btn-wrapper">
                    ...
                    <p class="text-left">How do I check the status of my ticket?</p>
                </button>
                </div>
                <div class="collepsing-div lg:px-4 px-2 bg-gray-800 text-white shadow-md shadow-blue-500" style="display:none;">
                                            <ul class="ml-4 md:ml-6">
                                                        <li class="list-disc text-sm py-1">Click on login at the bottom menu icons on your mobile device</li>
                                                        <li class="list-disc text-sm py-1">Log in using the index number as username and temporal index number as password</li>
                                                        <li class="list-disc text-sm py-1">Continuing students should use their student number as both username and password</li>
                                                        <li class="list-disc text-sm py-1">You&#039;ll be redirected to a page showing all ticktes you have issued</li>
                                                        <li class="list-disc text-sm py-1">Click on the &quot;i&quot; icon to view the response sent to your ticket</li>
                                                    </ul>
        ...
        <div class="fixed bottom-16 md:bottom-5 lg:right-5 right-2 w-36 z-10">
            <div class="bg-gray-100 text-xl shadow-lg shadow-gray-900 text-gray-900 hover:cursor-pointer rounded-full px-4 py-2">
                <div class="w-8 h-8 flex items-center">
                    <img src="https://helpdesk.uew.aamusted.gh/images/whatsapp.png" alt="">
            ...
            <!-- Staff Mobile Navigation -->
             ...
             <!-- Student Mobile Navigation -->
                ...
                <!-- <div class="absolute w-full -ml-3">
                    <a href="https://helpdesk.uew.edu.gh/users/tickets/create" class="flex mx-auto items-center justify-center text-gray-100 bg-gradient-to-r from-blue-600 to-red-500 rounded-full h-16 w-16 -mt-16">
                ...
                <a href="../../tickets/create.php" class="flex flex-col items-center text-gray-700">
                ...
                <a href="../create.php" class="flex flex-col items-center text-gray-700">
