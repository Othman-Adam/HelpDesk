        ...
        <div id="sideBar" class="fixed z-40 hidden transform transition-transform duration-700 ease-in-out px-2 min-h-screen bg-gray-900 w-full top-0 text-gray-400 right-0" id="navbar-default">
          ...
          <ul class="mt-32 space-y-2">
            <li class="border-b border-gray-800">
                <a href="../../../index.html" class="flex items-center justify-start p-2 rounded hover:bg-gray-300 hover:text-blue-900 group">
    ...
    <div class="relative hidden lg:block bg-emerald-800 lg:w-60 mt-10 h-screen">
        ...
        <div class="flex-1 my-4 lg:m-10 shadow-xl rounded-md">
            <div class="w-full text-center bg-red-700 text-base lg:text-xl py-4 text-white uppercase font-semibold p-4">
                    Course Registration F.A.Q <span class="lowercase">s</span>.
            </div>
                ...
                <div class="btn-wrapper">
                    ...
                    <p class="text-left">I do not have clearance to register online since I have fee arrears. What should I do?</p>
                </button>
                </div>
                <div class="collepsing-div lg:px-4 px-2 bg-gray-800 text-white shadow-md shadow-blue-500" style="display:none;">
                                            <ul class="ml-4 md:ml-6">
                                                        <li class="list-disc text-sm py-1">Go to the Finance Office section at the Student Center to seek clearance</li>
                                                    </ul>
                ...
                <div class="btn-wrapper">
                    ...
                    <p class="text-left">How can I correct a mistake with courses registered?</p>
                </button>
                </div>
                <div class="collepsing-div lg:px-4 px-2 bg-gray-800 text-white shadow-md shadow-blue-500" style="display:none;">
                                            <ul class="ml-4 md:ml-6">
                                                        <li class="list-disc text-sm py-1">Go to your Department Examinations Officer or Programme Coordinator</li>
                                                    </ul>
                ...
                <div class="btn-wrapper">
                    ...
                    <p class="text-left">Courses have not been set up for me to register. What should I do?</p>
                </button>
                </div>
                <div class="collepsing-div lg:px-4 px-2 bg-gray-800 text-white shadow-md shadow-blue-500" style="display:none;">
                                            <ul class="ml-4 md:ml-6">
                ...
                <div class="btn-wrapper">
                    ...
                    <p class="text-left">How do I register courses for the semester?</p>
                </button>
                </div>
                <div class="collepsing-div lg:px-4 px-2 bg-gray-800 text-white shadow-md shadow-blue-500" style="display:none;">
                                            <ul class="ml-4 md:ml-6">
                                                        <li class="list-disc text-sm py-1">Visit the OSIS portal or go to https://osissip.osis.online/auth/login</li>
                                                        <li class="list-disc text-sm py-1">Login, click on the menu icon and select Course Registration from the menu</li>
                                                        <li class="list-disc text-sm py-1">Follow the instructions</li>
                                                    </ul>
                ...
                <div class="btn-wrapper">
                    ...
                    <p class="text-left">Am I to submit any hardcopy registration slip?</p>
                </button>
                </div>
                <div class="collepsing-div lg:px-4 px-2 bg-gray-800 text-white shadow-md shadow-blue-500" style="display:none;">
                                            <ul class="ml-4 md:ml-6">
                                                        <li class="list-disc text-sm py-1">Inquire from your Department Examinations Officer or Programme Coordinator</li>
                                                    </ul>
        ...
        <div class="flex w-full justify-between items-center px-4">
            ...
            <!-- Staff Mobile Navigation -->
             ...
             <!-- Student Mobile Navigation -->
                ...
                <a href="../create.html" class="flex flex-col items-center text-gray-700">
