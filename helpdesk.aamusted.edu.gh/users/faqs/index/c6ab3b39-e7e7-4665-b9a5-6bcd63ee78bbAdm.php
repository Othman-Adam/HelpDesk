    ...
    <div class="relative hidden lg:block bg-emerald-800 lg:w-60 mt-10 h-screen">
        ...
        <div class="flex-1 my-4 lg:m-10 shadow-xl rounded-md">
            <div class="w-full text-center bg-red-700 text-base lg:text-xl py-4 text-white uppercase font-semibold p-4">
                    Admissions F.A.Q <span class="lowercase">s</span>.
            </div>
                ...
                <div class="btn-wrapper">
                    ...
                    <p class="text-left">Can I continue application online after deadline has elapsed?</p>
                </button>
                </div>
                <div class="collepsing-div lg:px-4 px-2 bg-gray-800 text-white shadow-md shadow-blue-500" style="display:none;">
                                            <ul class="ml-4 md:ml-6">
                                                        <li class="list-disc text-sm py-1">Yes, only If you purchased the form before deadline.</li>
                                                    </ul>
                ...
                <div class="btn-wrapper">
                    ...
                    <p class="text-left">What do I do when I am unable to progress past the application review stage?</p>
                </button>
                </div>
                <div class="collepsing-div lg:px-4 px-2 bg-gray-800 text-white shadow-md shadow-blue-500" style="display:none;">
                                            <ul class="ml-4 md:ml-6">
                                                        <li class="list-disc text-sm py-1">Please review your application and fill in the mandatory fields that are not filled in.</li>
                                                    </ul>
                ...
                <div class="btn-wrapper">
                    ...
                    <p class="text-left">What is the address for the AAMUSTED admission portal?</p>
                </button>
                </div>
                <div class="collepsing-div lg:px-4 px-2 bg-gray-800 text-white shadow-md shadow-blue-500" style="display:none;">
                                            <ul class="ml-4 md:ml-6">
                                                <li class="list-disc text-sm py-1">
                                                    <a href="https://application.aamusted.edu.gh/applicant/" target="_blank">Click Here</a>
                                                </li>
                ...
                <div class="btn-wrapper">
                    ...
                    <p class="text-left">What do i do when i get to know i have been given admission?</p>
                </button>
                </div>
                
                <div class="collepsing-div lg:px-4 px-2 bg-gray-800 text-white shadow-md shadow-blue-500" style="display:none;">
                                            <ul class="ml-4 md:ml-6">
                                                        <li class="list-disc text-sm py-1">Visit the admission portal or  <li class="list-disc text-sm py-1">
                                                            <a href="https://misc.aamusted.edu.gh/admission/?_gl=1*cznoui*_ga*MTUzOTA0NDg2Ny4xNzIxNTcwMTAx*_ga_13L0H5MMWZ*MTcyMTkxMDQ5Ni4yLjEuMTcyMTkxNDI5MC4wLjAuMA.." target="_blank">Click Here</a>
                                                        </li>
                                                        </li>
                                                        <li class="list-disc text-sm py-1">Provide your Admission ID and Either your Firstname or Lastname</li>
                                                        <li class="list-disc text-sm py-1">Click on Check</li>
                                                    </ul>
